...
public class DemoApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n# Use Case 1: Tracking Logged-in Users (Set Operations)");
		...
		// Increment option 1 votes
		jedis.hincrBy(pollKey, "option1_votes", 1);
		System.out.println("After increment - Option 1 votes: " + jedis.hget(pollKey, "option1_votes"));
